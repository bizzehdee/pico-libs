...
add_subdirectory(${CMAKE_CURRENT_LIST_DIR}/src ${CMAKE_BINARY_DIR}/pico-libs/src)

if (PICO_LIBS_TESTS_ENABLED OR PICO_LIBS_TOP_LEVEL_PROJECT)
    add_subdirectory(${CMAKE_CURRENT_LIST_DIR}/test {CMAKE_BINARY_DIR}/pico-libs/test)
endif ()
